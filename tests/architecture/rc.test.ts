...
describe('aktive Markdown-Dokumentation', () => {
  ...
  it('hält zentrale Navigation und Benutzerhandbuch bei Dokumentation, Sitzungen und Wahlen synchron', () => {
    ...
    expect(handbookIndex.indexOf('[Glossar](19-glossar.md)')).toBeGreaterThan(handbookIndex.indexOf('[Amtsübergabe und Vertretung](18-amtsuebergabe-und-vertretung.md)'));
