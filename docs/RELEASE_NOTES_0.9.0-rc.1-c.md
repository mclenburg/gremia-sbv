# Release Notes – Gremia.SBV 0.9.0-rc.1-c

Stand: 0.9.0-rc.1-c

## Status

`0.9.0-rc.1-c` ist der erste Release Candidate von Gremia.SBV. Dieser Stand friert die fachliche Funktionalität nach der 0.8.13-Härtungsphase ein und dient der technischen, datenschutzfachlichen und praktischen Evaluation vor einem stabilen Release.
