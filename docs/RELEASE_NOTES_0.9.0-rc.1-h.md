# Release Notes – Gremia.SBV 0.9.0-rc.1-h

Stand: 0.9.0-rc.1-h

## Status

`0.9.0-rc.1-h` ist der erste Release Candidate von Gremia.SBV. Dieser Stand friert die fachliche Funktionalität nach der 0.8.13-Härtungsphase ein und dient der technischen, datenschutzfachlichen und praktischen Evaluation vor einem stabilen Release.
...
- Der Smoke-Test öffnet eine Fallakte, erfasst im großen Protokolltextfeld `/todo Inklusionsamt informieren`, erwartet den Dialog „Aufgabe einfügen“ und prüft anschließend die Ersetzung im Textfeld.
