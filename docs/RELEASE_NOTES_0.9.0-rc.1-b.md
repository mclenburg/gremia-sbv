# Release Notes – Gremia.SBV 0.9.0-rc.1-b

Stand: 0.9.0-rc.1-b

## Status

`0.9.0-rc.1-b` ist der erste Release Candidate von Gremia.SBV. Dieser Stand friert die fachliche Funktionalität nach der 0.8.13-Härtungsphase ein und dient der technischen, datenschutzfachlichen und praktischen Evaluation vor einem stabilen Release.

Nach diesem Release Candidate werden keine neuen Fachfeatures, neuen Inlinebefehle, großen Refactorings oder neuen Datenbankstrukturen mehr aufgenommen, sofern sie nicht zur Behebung eines Security-, Datenverlust-, Build-, Migrations- oder RC-blockierenden Fehlers zwingend erforderlich sind.
