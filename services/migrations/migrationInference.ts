...
export class MigrationInference extends MigrationCore {
  ...
  private looksAppliedCurrent(version: string): boolean {
    switch (version) {
        ...
        case '0054':
          return this.tableExists('gremia_br_workspace_actions')
            && GREMIA_BR_WORKSPACE_ACTIONS_REQUIRED_COLUMNS.every((column) => this.columnExists('gremia_br_workspace_actions', column));
        case '0055':
          return this.tableExists('case_handover_exports')
