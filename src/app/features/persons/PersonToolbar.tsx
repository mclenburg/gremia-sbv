...
export function PersonToolbar({ query, selected, onQueryChange, onOpenCreate, onOpenCaseCreate, onOpenEdit, onOpenPrivacyAction, onOpenImport, onExportIcal }: PersonToolbarProps) {
  return (
    <div className="person-toolbar">
      ...
      <button type="button" className="industrial-secondary-button" disabled={!selected} data-e2e="open-person-edit-dialog" onClick={onOpenEdit}>Person bearbeiten</button>
