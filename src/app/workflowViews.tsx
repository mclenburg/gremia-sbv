...
export function CasesView({
  ...
  async function renderAndDownloadProcessTemplate(template: TemplateRecord) {
    ...
    try {
      ...
      } else if (processTemplateModal.processType === 'termination_hearing' && isTerminationHearingRecord(processTemplateModal.process)) {
        const scan = scanSensitiveExportText(`${result.subject}\n\n${result.body}\n\n${buildTerminationExportContext(processTemplateModal.process)}\n\n${terminationPrivacyExportNotice()}`, {
