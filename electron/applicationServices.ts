...
export class ApplicationServices {
  ...
  gremiaBrWorkspaceActions = (): GremiaBrWorkspaceActionService =>
    this.databaseService('gremiaBrWorkspaceActions', (database) => new GremiaBrWorkspaceActionService(database, this.dataDirectoryProvider, this.gremiaBrAuth));
  ...
  transferIdentity = (): TransferInstanceIdentityService =>
    this.databaseService('transferIdentity', (database) => new TransferInstanceIdentityService(database));
