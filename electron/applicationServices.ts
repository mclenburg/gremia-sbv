...
export class ApplicationServices {
  ...
  transferRecipientProfiles = (): TransferRecipientProfileService =>
    this.databaseService('transferRecipientProfiles', (database) => new TransferRecipientProfileService(database, this.auditLog()));
