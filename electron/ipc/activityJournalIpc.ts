...
export function registerActivityJournalIpc(ipcMain: IpcMain, security: SecurityService, services: ApplicationServices): void {
  ...
  registerIpcHandler(ipcMain, 'activityJournal:list', async (_event, filter: unknown) =>
    journal().listEntries((filter ?? {}) as ActivityJournalListFilter)
  );
  registerIpcHandler(ipcMain, 'activityJournal:get', async (_event, id: unknown) =>
    journal().getEntry(assertString(id, 'activityJournal:get', 'Journal-ID', { minLength: 1, maxLength: 120 })) ?? null
  );
  registerIpcHandler(ipcMain, 'activityJournal:create', async (_event, input: unknown) =>
    journal().createEntry(assertRecordInput<CreateActivityJournalEntryInput>(input, 'activityJournal:create'))
  );
  registerIpcHandler(ipcMain, 'activityJournal:update', async (_event, id: unknown, input: unknown) =>
    journal().updateEntry(
  ...
  registerIpcHandler(ipcMain, 'activityJournal:delete', async (_event, id: unknown) =>
    journal().deleteEntry(assertString(id, 'activityJournal:delete', 'Journal-ID', { minLength: 1, maxLength: 120 }))
  );
  registerIpcHandler(ipcMain, 'activityJournal:links:list', async (_event, entryId: unknown) =>
    journal().listLinks(assertString(entryId, 'activityJournal:links:list', 'Journal-ID', { minLength: 1, maxLength: 120 }))
  );
  registerIpcHandler(ipcMain, 'activityJournal:links:add', async (_event, entryId: unknown, target: unknown) =>
    journal().addLink(
  ...
  registerIpcHandler(ipcMain, 'activityJournal:links:remove', async (_event, entryId: unknown, linkId: unknown) =>
    journal().removeLink(
  ...
  registerIpcHandler(ipcMain, 'activityJournal:summary', async (_event, filter: unknown) =>
    journal().getSummary((filter ?? {}) as ActivityJournalSummaryFilter)
  );
  registerIpcHandler(ipcMain, 'activityJournal:export', async (_event, filter: unknown, mode: unknown, options: unknown) =>
  ...
  registerIpcHandler(ipcMain, 'activityJournal:prefill:context', async (_event, context: unknown) => {
  ...
  registerIpcHandler(ipcMain, 'activityJournal:prefill:deadline', async (_event, deadline: unknown) =>
    buildFromDeadline(assertRecordInput(deadline, 'activityJournal:prefill:deadline', 'Frist'))
  );
  registerIpcHandler(ipcMain, 'activityJournal:prefill:closed-deadline', async (_event, deadline: unknown) =>
    buildFromClosedJournalDeadline(assertRecordInput(deadline, 'activityJournal:prefill:closed-deadline', 'Frist'))
  );
  registerIpcHandler(ipcMain, 'activityJournal:preferences:get', async (_event, contextType: unknown) =>
  ...
  registerIpcHandler(ipcMain, 'activityJournal:preferences:remember', async (_event, contextType: unknown, category: unknown) =>
